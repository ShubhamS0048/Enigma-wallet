					...
					<li>
						<ul class="vm1 collapsible" data-collapsible="accordion" style="margin-top: 30px;">
							...
							<li id="ms4" class="active" style="position:relative;">
								<a href="securitycenter.php" style="color:#00aeeb;" class="collapsible-header">
									<!--<i>
								...
								<div id="send1ststep">
									<div class="modal-head">
										<div class="col l8">
											...
											<p>Please update your password regularly</p>
										</div>
									...
									<div class="form-horizontal white signUpContainer center" style="width:90%;padding:1%;padding-left:5%">
										<fieldset>
											<div class="row" style="border-bottom:1px solid black;">
												...
												<div class="form-group col-md-3" style="margin-left:5px; width:40%; margin-right:4%; font-weight:bold;font-size:1.3em; 
												float:right;margin-bottom:5px; ">
													<input type="submit" class="btn Lockerblue" id="btnverify" name="btnverify"  value="Verify Email"/>
											...
											<div class="row">
												...
												<div class="form-group col-md-6" id="half2" style="margin-bottom:5px">
											...
											<div class="row">
												<div class="form-group col-md-6" style="margin-left:5px; width:40%;font-weight:bold;font-size:1.3em">
													<input type="submit" class="btn Lockerblue" id="btnlogin" name="btnlogin" value="Update Login Password"/>
												</div>
												<div class="form-group col-md-6" style="width:50%;font-weight:bold;font-size:1.3em">
													<input type="submit" class="btn Lockerblue" id="btnSpending" name="btnSpending" value="Update Spending Password"/>
												</div>
											<div> 
										</fieldset>
									</div>
