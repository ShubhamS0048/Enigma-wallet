										...
										<div name="loginForm" role="form" autocomplete="off" novalidate="" 
											...
											<fieldset>
												...
												<?php if(!empty($message)){ ?>
													<label style="float:left">The transcation has been successfully intiative. Your Transcation ID is <?php echo $message;?></label>
												<?php 
												} else { 
												?>
													<label style="float:left">The is some issue in processng your transcation. Please try after some time</label>
												<?php
												}
												?>
