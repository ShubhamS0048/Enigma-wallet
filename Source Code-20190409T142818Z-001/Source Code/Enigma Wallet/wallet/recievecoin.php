				...
				<ul class="side-nav fixed clearfix left" id="nav-mobile" style="transform: translateX(0px);">
					<li>
						<ul class="vm1 collapsible" data-collapsible="accordion" style="margin-top: 30px;">
							...
							<li id="ms2" class="active"><a style="color: rgb(216, 26, 25);" href="transactions.php" class="collapsible-header"><!--<i class="zmdi zmdi-swap-vertical icontransaction" style="font-size:30px;"></i>-->Transactions</a></li>
							...
							<div class="modal-content">
								<div id="send1ststep">
									<div class="modal-head">
										<div class="col l8">
											<h5><!--<i class="zmdi zmdi-long-arrow-up zmdi-hc-fw"></i>-->Receive Token</h5>
										...
										<fieldset>
											...
											<div class="row">
												...
												<div class="form-group col-md-3" id="half1" style="margin-bottom:5px">
													<label style="float:left;margin-top:10px;padding-left:20px; color:#000;"><b><?php echo $new_address;?></b></label>
												</div>
												<div class="form-group col-md-5" id="half1" style="margin:0px">
													<label style="float:right;padding:0px;margin-top:-5px;">
												...
												alt="QR Code" style="width:256px;height:256px;border:0;"/></a></label>
												</div>
											</div>											
										</fieldset>
									</div>
